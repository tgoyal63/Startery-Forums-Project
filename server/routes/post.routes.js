...
const { createPostSchema, searchPostsSchema, userPostsSchema } = require("../validations/post.validation");

class PostRouter extends BaseRouter {
  initRoutes() {
    // this.router.put("/:id", verifyToken, verifyPermission("Post"), postController.updatePost); // Update post by id
