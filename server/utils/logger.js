...
const logger = winston.createLogger({
    ...
    transports: [
        new winston.transports.File({ filename: path.join(config.logDirectory, '/error.log'), level: 'error' }),
        new winston.transports.File({ filename: path.join(config.logDirectory, '/combined.log') }),
    ],
});
